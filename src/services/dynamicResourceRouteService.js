...
baasicDynamicResourceRouteService.parse(
	...
	{embed: '<embedded-resource>'}
				...
				**/					
                ...
                permissions: {
					/**
					* Parses get permissions route; this URI template should be expanded with the Id of the dynamic resource and name of the dynamic resource schema.					
...
baasicDynamicResourceRouteService.permissions.get.expand({
    ...
    schemaName: '<schema-name>'
					...
					**/ 				
					...
					/**
					* Parses update permissions route; this URI template should be expanded with the Id of the dynamic resource and name of the dynamic resource schema.			
